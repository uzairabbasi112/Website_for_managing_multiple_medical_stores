		...
		<div class="pd-ltr-20">
            ...
            <div class="col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px"  style="border: 2px solid yellow;">
						...
						<div>
							<?php $sql = "select medicine.MedicineName,stock.Quantity from stock join medicine on stock.MedicineID = medicine.MedicineID  where stock.ShopID = 1";

							$query = mysqli_query($conn,$sql) or die(mysqli_error());
							while ($row = mysqli_fetch_array($query)) {
								?>
								<ul style="padding-left: 0px;">
								<li class="d-flex align-items-center justify-content-between" style="display: grid;grid-template-columns: 30% 40% 30%;border:2px solid black;padding:5px;margin:10px;border-radius:20px;">
				...
				<div class="col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px"  style="border: 2px solid greenyellow;" >
						...
						<div>
						<?php $sql = "select medicine.MedicineName,stock.Quantity from stock join medicine on stock.MedicineID = medicine.MedicineID  where stock.ShopID = 2";
                ...
                <div class="col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px" style="border: 2px solid cyan;" >
						...
						<div>
						<?php $sql = "select medicine.MedicineName,stock.Quantity from stock join medicine on stock.MedicineID = medicine.MedicineID  where stock.ShopID = 3";
                ...
                <div class="col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px" style="border: 2px solid aquamarine;" >
						...
						<div>
						<?php $sql = "select medicine.MedicineName,stock.Quantity from stock join medicine on stock.MedicineID = medicine.MedicineID  where stock.ShopID = 4";
