	...
	<div class="main-container" style="margin-top: 0px;padding-top:0px;margin-left:-10%">
		<div class="pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">Stock Information</h2>
			</div>
			<div class="row pb-10">
            ...
            <div class="col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px"  style="background-color:yellow;">
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Stock by Medicines</div>
						</div>
						<div>
							<?php $sql = "select * from stock join medicine on stock.MedicineID = medicine.MedicineID  where stock.ShopID = 1";
							...
							while ($row = mysqli_fetch_array($query)) {
								...
								<li class="d-flex align-items-center justify-content-between" style="display: grid;grid-template-columns: 30% 40% 30%;border:1px solid black;padding:5px;margin:10px;border-radius:20px;">
									...
									<div></div>
									<div class="font-15 weight-700"><?php echo $row['Quantity']; ?></div>
				...
				<div class="col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px"  style="background-color:greenyellow;" >
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Stock by Medicines</div>
						</div>
						<div>
							<?php 
							$sql = "select * from stock join medicine on stock.MedicineID = medicine.MedicineID  where stock.ShopID = 2";
							$query = mysqli_query($conn,$sql) or die(mysqli_error());
							while ($row = mysqli_fetch_array($query)) {
								?>
								<ul style="padding-left: 0px;">
                ...
                <div class="col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px" style="background-color:cyan;" >
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Stock by Medicines</div>
						</div>
						<div>
                            ...
                            $sql = "select * from stock join medicine on stock.MedicineID = medicine.MedicineID  where stock.ShopID = 3";
							$query = mysqli_query($conn,$sql) or die(mysqli_error());
							while ($row = mysqli_fetch_array($query)) {
								?>
								<ul style="padding-left: 0px;">
                ...
                <div class="col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px" style="background-color:aquamarine;" >
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Stock by Medicines</div>
						</div>
						<div>
							...
							$sql = "select * from stock join medicine on stock.MedicineID = medicine.MedicineID  where stock.ShopID = 4";
							$query = mysqli_query($conn,$sql) or die(mysqli_error());
							while ($row = mysqli_fetch_array($query)) {
								?>
								<ul style="padding-left: 0px;">
